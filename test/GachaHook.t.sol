...
contract TestGachaHook is Test, Deployers {
    ...
    function setUp() public {
        ...
        deployCodeTo("GachaHook.sol", abi.encode(manager, "Points Token", "TEST_POINTS"), address(flags));
    ...
    {'eth_amount': 2995354955910434, 'eth_amount_readable': 0.002995354955910434, 'token_amount': 2995354955910412,
    'token_amount_readable': 0.002995354955910412}

        Therefore, Δx = 0.002995354955910434 ETH and Δy = 0.002995354955910434 Tokens

    NOTE: Python and Solidity handle precision a bit differently, so these are rough amounts. Slight loss of precision
    is to be expected.
    ...
    function test_addLiquidityAndSwapWithReferral() public {
        ...
        assertApproxEqAbs(pointsBalanceAfterAddLiquidity - pointsBalanceOriginal, 2_995_354_955_910_434, 0.00001 ether);
        assertApproxEqAbs(
